...
public:
	enum CurveChannel
	{
		Curve_R = Qt::red, Curve_G = Qt::green, Curve_B = Qt::blue, Curve_RGB = Qt::white
	};

	SingleCurveWidget(CurveAdjustWindow* curveAdjustWindow, QLineEdit* edit, CurveChannel channel, QWidget* parent = nullptr);
	~SingleCurveWidget() {}	
