...
class CrosshatchWidget : public QWidget
{
	Q_OBJECT
public:
	CrosshatchWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_spacing(0.0f), m_lineWidth(0.0f) { m_ui.setupUi(this); initCrosshatch(); }
	~CrosshatchWidget()
	{
		if(m_filter)
		{
...
class EdgeWidget : public QWidget
{
	Q_OBJECT
public:
	EdgeWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_mix(0.0f), m_stride(0.0f) { m_ui.setupUi(this); initEdge(); }
	~EdgeWidget()
	{
		if(m_filter)
		{
...
class EmbossWidget : public QWidget
{
	Q_OBJECT
public:
	EmbossWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_mix(0.0f), m_stride(0.0f), m_angle(0.0f) { m_ui.setupUi(this); initEmboss(); }
	~EmbossWidget()
	{
		if(m_filter)
		{
...
class HalftoneWidget : public QWidget
{
	Q_OBJECT
public:
	HalftoneWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_dotSize(0.0f) { m_ui.setupUi(this); initHalftone(); }
	~HalftoneWidget()
	{
		if(m_filter)
		{
...
class HazeWidget : public QWidget
{
	Q_OBJECT
public:
	HazeWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_distance(0.0f), m_slope(0.0f) { m_ui.setupUi(this); initHaze(); }
	~HazeWidget()
	{
		if(m_filter)
		{
...
class PolkadotWidget : public QWidget
{
	Q_OBJECT
public:
	PolkadotWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_dotScaling(0.0f) { m_ui.setupUi(this); initPolkadot(); }
	~PolkadotWidget()
	{
		if(m_filter)
		{
...
class BilateralBlurWidget : public QWidget
{
	Q_OBJECT
public:
	BilateralBlurWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_blurScale(0.0f), m_disFactor(0.0f), m_repeatTimes(1) { m_ui.setupUi(this); initBlateralBlur(); }
	~BilateralBlurWidget()
	{
		if(m_filter)
		{
...
class LerpblurWidget : public QWidget
{
	Q_OBJECT
public:
	LerpblurWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_intensity(0.0f) { m_ui.setupUi(this); initLerpblur(); }
	~LerpblurWidget()
	{
		if(m_filter)
		{
...
class SketchWidget : public QWidget
{
	Q_OBJECT
public:
	SketchWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_intensity(0.0f) { m_ui.setupUi(this); initSketch(); }
	~SketchWidget()
	{
		if(m_filter)
		{
...
class MaxValueWidget : public QWidget
{
	Q_OBJECT
public:
	MaxValueWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr) { m_ui.setupUi(this); initMaxValue(); }
	~MaxValueWidget()
	{
		if(m_filter)
		{
...
class MinValueWidget : public QWidget
{
	Q_OBJECT
public:
	MinValueWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr) { m_ui.setupUi(this); initMinValue(); }
	~MinValueWidget()
	{
		if(m_filter)
		{
...
class WaveWidget : public QWidget
{
    Q_OBJECT
public:
    WaveWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr), m_motion(0.0f), m_angle(0.0f), m_strength(0.0f) { m_ui.setupUi(this); initWave(); }
    ~WaveWidget()
    {
        if(m_filter)
        {
...
class ColorMappingWidget : public QWidget
{
	Q_OBJECT
public:
	ColorMappingWidget(MainWindow* mainWindow, QWidget* parent = nullptr) : QWidget(parent), m_mainWindow(mainWindow), m_filter(nullptr) { m_ui.setupUi(this); initColorMapping(); }
	~ColorMappingWidget()
	{
		if (m_filter)
		{
