...
int main(int argc, char* argv[])
{
    ...
    CGE_LOG_INFO(
        "After completing an operation, please click Save. A series of files will be generated. Open the _cge.txt file, copy the text, paste it into the text box above, and click the center button to verify the rule is correct.\n\n"
