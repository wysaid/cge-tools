...
const static char* const s_fshMotionBlur = CGE_SHADER_STRING_PRECISION_H(
    varying vec2 textureCoordinate; uniform sampler2D inputImageTexture; uniform vec2 samplerStep;
    uniform vec2 blurNorm; uniform float samplerRadius; const int number = 10;  // sum = number*2 + 1
