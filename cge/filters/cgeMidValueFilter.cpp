 ...
 *      Author: Wang Yang
 * Description: Median value filter
 * Reference: http://www.cnblogs.com/BYTEMAN/archive/2012/07/21/2602181.html
 */
...
{
    if (!initShadersFromString(s_vshMidValue3x3, s_fshMidValue3x3)) return false;
