...
static CGEConstString s_fshHaze =
    CGE_SHADER_STRING_PRECISION_M(varying vec2 textureCoordinate;

                                  uniform sampler2D inputImageTexture;

                                  uniform float dis; uniform float slope; uniform vec3 hazeColor;
