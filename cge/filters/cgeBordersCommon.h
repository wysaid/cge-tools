...
public:
    ...
    virtual void setBlocks(
        GLfloat* blocks, GLfloat w,
        GLfloat h);  // The array size of "blocks" must be 12! w&h stands for the real size of the block-texture.
...
public:
    ...
    virtual void setBlocks(GLfloat* blocks, GLfloat w,
                           GLfloat h);  // The array size must be 8! w&h stands for the real size of the block-texture.
...
public:
    virtual bool init();
    virtual void setTexBlock(GLfloat* block,
                             float texRatio = 1.0f);  // The array size must be 8! The 4 elements in front stand for the
                                                      // TexBlock and the remain 4 elements stand for the TexArea. w&h
                                                      // stands for the real size of the block-texture.
    virtual void render2Texture(CGEImageHandlerInterface* handler, GLuint srcTexture, GLuint vertexBufferID);
    virtual void setBorderSize(GLfloat borderX, GLfloat borderY)
    {
        m_borderSizeX = borderX;
        m_borderSizeY = borderY;
    }
...
public:
    virtual bool init();
    virtual void setBlocks(
        GLfloat* blocks);  // The array size must be 12! w&h stands for the real size of the block-texture.
