...
#include "../core/cgeShaderFunctions.h"
...
namespace CGE
{
	...
	public:
		...
		//Only applies global default settings to sprites created afterward. For sprites already created, use the set*Flip functions individually
