...
namespace CGE
{
	...
	{
		Mat4 mvp = modelViewProjectionMatrix * (Mat4(m_scaling[0], 0.0f, 0.0f, 0.0f,
		...
		glVertexAttribPointer(m_vertAttribLocation, m_vertBuffer.componentSize, m_vertBuffer.bufferDataKind, GL_FALSE, m_vertBuffer.bufferStride, 0);
