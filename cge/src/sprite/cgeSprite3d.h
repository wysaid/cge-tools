...
namespace CGE
{
	...
	protected:
		...
		float m_zIndex; //Sprite3d z-index (no actual significance; Sprite3d coordinates contain the z value; this zIndex is used only as a rendering sort key during animation)		
	};
