...
#if !(defined(_CGE_VIDEO_H_) || defined(_CGE_EXT_NO_VIDEO_))
#define _CGE_VIDEO_H_
...
namespace CGE
{
	...
	public:
		...
		virtual bool updateVideoFrame(const CGEVideoFrameBufferData* data = nullptr) { return false; }
	...
	public:
		...
		//Alternative initialization method, not for use alongside open()
