...
// 			return false;
	...
	bool CGEVideoPlayer::open(const char* filename, CGEVideoDecodeHandler::SamplingStyle s)
	{
		return false;
	}

	void CGEVideoPlayer::close()
	{

	}

	void CGEVideoPlayer::play()
	{

	}

	void CGEVideoPlayer::stop()
	{

	}

	void CGEVideoPlayer::pause()
	{

	}

	void CGEVideoPlayer::resume()
	{

	}

	bool CGEVideoPlayer::seek(float position)
	{
		return false;
	}
