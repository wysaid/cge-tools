...
public:
    ...
    void setBlurScale(float value) { m_blurScale = value; }

    // Range: [1.0, 20.0], none for the origin. Default: 8.0  (It'll show the origin when blurScale value is 1.0
    void setDistanceNormalizationFactor(float value) { m_proc->setDistanceNormalizationFactor(value); }

    void setRepeatTimes(int n) { m_repeatTimes = n; }
