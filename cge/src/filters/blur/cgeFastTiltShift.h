...
public:
    ...
    static CGEFastTiltShiftInterface* CreateVector() { return Create(VECTOR); }

    static CGEFastTiltShiftInterface* CreateEllipse() { return Create(ELLIPSE); }
};
