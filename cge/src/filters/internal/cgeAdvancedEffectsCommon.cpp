...
void CGEAdvancedEffectOneStepFilterHelper::render2Texture(CGEImageHandlerInterface* handler, GLuint srcTexture,
...
void CGEAdvancedEffectTwoStepFilterHelper::render2Texture(CGEImageHandlerInterface* handler, GLuint srcTexture,
                                                          GLuint vertexBufferID)
{
    CGESizei sz = handler->getOutputFBOSize();
    m_program.bind();
