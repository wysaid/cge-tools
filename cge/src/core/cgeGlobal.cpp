...
bool cgeInitialize(int width, int height, CGEGlobalConfig::InitArguments arg)
{
    ...
    if ((arg & CGEGlobalConfig::CGE_INIT_COMMONVERTEXBUFFER) && CGEGlobalConfig::sVertexBufferCommon == 0)
    {
        ...
        if (CGEGlobalConfig::sVertexBufferCommon == 0) return false;
    ...
    if (arg & CGEGlobalConfig::CGE_INIT_SPRITEBUILTIN) cgeSpritesInitBuiltin();
...
extern "C"
{
    ...
    GLuint cgeGenCommonQuadArrayBuffer()
    {
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(CGE::CGEGlobalConfig::sVertexDataCommon),
                     CGE::CGEGlobalConfig::sVertexDataCommon, GL_STATIC_DRAW);
