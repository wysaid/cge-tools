...
namespace CGE
{
	...
	// Texture load callback. Note: to keep the interface simple, the texture unit returned by the callback must be released by the caller.
	// The returned texture must not be a special texture type that glDeleteTextures cannot handle.
