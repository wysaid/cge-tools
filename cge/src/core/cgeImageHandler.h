...
namespace CGE
{
	...
	public:
		...
		// Call this function to retrieve the final result of the handler's current processing pass (the handler becomes invalid after calling this and must be re-initialized)
